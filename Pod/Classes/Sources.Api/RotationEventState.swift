...
public enum RotationEventState {
    ...
    */
    public func toString() -> String {
        switch self {
            case .WillStartRotation: return "WillStartRotation"
            case .IsRotating: return "IsRotating"
            case .DidFinishRotation: return "DidFinishRotation"
    ...
    */
    public static func toEnum(string:String?) -> RotationEventState {
