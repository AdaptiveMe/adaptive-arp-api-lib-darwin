...
public class ContactSocial : APIBean {
    ...
    */
    public struct Serializer {
        public static func fromJSON(json : String) -> ContactSocial {
        ...
        static func fromDictionary(dict : NSDictionary) -> ContactSocial {
            let resultObject : ContactSocial = ContactSocial()
            ...
            if let value : AnyObject = dict.objectForKey("socialNetwork") {
                if "\(value)" as NSString != "<null>" {
                    resultObject.socialNetwork = ContactSocialNetwork.toEnum(((value as! NSDictionary)["value"]) as? String)
                }
            }
        ...
        public static func toJSON(object: ContactSocial) -> String {
            let jsonString : NSMutableString = NSMutableString()
            // Start Object to JSON
            jsonString.appendString("{ ")

            // Fields.
            object.profileUrl != nil ? jsonString.appendString("\"profileUrl\": \"\(JSONUtil.escapeString(object.profileUrl!))\", ") : jsonString.appendString("\"profileUrl\": null, ")
