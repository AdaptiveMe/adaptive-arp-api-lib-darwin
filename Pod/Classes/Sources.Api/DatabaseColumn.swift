...
public class DatabaseColumn : APIBean {
    ...
    */
    public struct Serializer {
        public static func fromJSON(json : String) -> DatabaseColumn {
        ...
        static func fromDictionary(dict : NSDictionary) -> DatabaseColumn {
            let resultObject : DatabaseColumn = DatabaseColumn()
        ...
        public static func toJSON(object: DatabaseColumn) -> String {
