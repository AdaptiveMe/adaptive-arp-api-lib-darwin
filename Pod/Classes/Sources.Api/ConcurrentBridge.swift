...
public class ConcurrentBridge : BaseUtilBridge, IConcurrent, APIBridge {
    ...
    /**
       API Delegate.
    */
    private var delegate : IConcurrent? = nil
    ...
    */
    public final func getDelegate() -> IConcurrent? {
    ...
    /**
       ...
       @param delegate The delegate implementing platform specific functions.
    */
    public final func setDelegate(delegate : IConcurrent) {
        self.delegate = delegate;
    }
    ...
    public override func invoke(request : APIRequest) -> APIResponse? {
        ...
        switch request.getMethodName()! {
            default:
                // 404 - response null.
                responseCode = 404
                responseMessage = "ConcurrentBridge does not provide the function '\(request.getMethodName()!)' Please check your client-side API version; should be API version >= v2.2.12."
        }
